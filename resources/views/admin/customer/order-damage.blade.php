                    ...
                    <div class="card radius-10 mb-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <form action="{{ url('/order/damage/list') }}" method="GET">
                                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <form action="{{ url('/order/damage/list')}}" method="get" class="user-form form-group mb-3">
                                            @csrf
                                    ...
                                    <div class="col-md-8">
                                        <form method="GET" action="{{ url('/order/damage/list') }}"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <a href="{{ url('/order/damage/list') }}" class="btn btn-sm btn-danger"><i
