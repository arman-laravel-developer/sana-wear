                    ...
                    <div class="card radius-10 mb-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <form action="{{ url('/order/missing/list') }}" method="GET">
                                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <form action="{{ url('/order/missing/list')}}" method="get" class="user-form form-group mb-3">
                                            @csrf
                                    ...
                                    <div class="col-md-8">
                                        <form method="GET" action="{{ url('/order/missing/list') }}"
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <a href="{{ url('/order/missing/list') }}" class="btn btn-sm btn-danger"><i
                                                        ...
                                                        <div class="action-dropdown-menu">
                                                            ...
                                                            <ul class="action-btn-list">
                                                                <li class="action-btn-list-item">
                                                                    <a href="{{ url('/pending/status/' .$order->id) }}"
